import re
from tkinter import Frame, filedialog, Button, Toplevel, Text, BOTH, END, Label, Entry, ttk
...
def update_category():
    ...
    category_name_entry.pack()
    new_category_name_label = Label(update_window, text="New Category name:", bg='gray10', fg="white", font=("Helvetica", 12))
